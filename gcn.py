...
class GCNNet(torch.nn.Module):
    ...
    def learn(self, data, optimizer: torch.optim.Optimizer, device: torch.device, criterion):
        ...
        link_labels = GCNNet.get_link_labels(data.train_neg_index, data.train_target_index, device)
    ...
    def evaluate(self, data, device: torch.device):
        ...
        for prfx in ['val', 'test']:
            ...
            link_labels = GCNNet.get_link_labels(neg_edge_index, tgt_edge_index, device)
